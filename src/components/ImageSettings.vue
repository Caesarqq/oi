<template>
    <div class="slider">
      <div class="button-container">
        <v-btn color="primary" @click="showSlider = true" class="mt-3 mb-3">Слайдер</v-btn>
      </div>
  
      <v-dialog v-model="showSlider" persistent max-width="300px" content-class="slider-dialog">
        <v-card>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="primary" @click="showSlider = false">Закрыть</v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
